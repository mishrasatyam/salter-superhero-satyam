let a = {
    ...
    "urls": [
        {
            "type": "detail",
            "url": "http://marvel.com/comics/characters/1009351/hulk?utm_campaign=apiRef&utm_source=c413a0f1ea1663ed87d16d1435965123"
        },
        {
            "type": "wiki",
            "url": "http://marvel.com/universe/Hulk_(Bruce_Banner)?utm_campaign=apiRef&utm_source=c413a0f1ea1663ed87d16d1435965123"
        },
        {
            "type": "comiclink",
            "url": "http://marvel.com/comics/characters/1009351/hulk?utm_campaign=apiRef&utm_source=c413a0f1ea1663ed87d16d1435965123"
        ...
        <div className="items-center rounded-lg shadow-lg mx-1 sm:mx-32 sm:mt-10 p-4  overflow-y-auto">
            ...
            <div className="p-4 font-medium">
                ...
                <details className="mt-4">
                    ...
                    <ul className="p-4">
                        {data[key].items.map(el => <li className="p-2">{el.name}</li>)}
                    </ul>
                </details>
                )}
                <details className="mt-4">
                    ...
                    <ul className="p-4">
                        {data.urls.map(el => <li className="p-2">
                            <a href={el.url} className="capitalize text-blue-500 hover:text-blue-600 hover:underline" target={"_blank"}>{el.type}</a>
                        </li>)}
                    </ul>
                </details>
            </div>
